...
# Before you start
1. Please install Redux devtools in your browser
...
you can also run `npm run start:development` or `npm run start:production` to launch the corresponding environment
